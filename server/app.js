...
app.post("/generateScopeSheet",  GeoImageService.getCoordinates,GeoImageService.centerCoordinates, GeoImageService.solarAerialImageCapture,GeoImageService.geoTiffURLToPngBuffer,LLMPromptService.basicDalleInteraction, (req, res) => {
