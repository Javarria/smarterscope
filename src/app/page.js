...
export default function Home() {
  ...
  return (
    <div style={{backgroundColor: "black"}}>
      ...
      <div className="h-screen border-green-500 border-2">
        <div className="w-full lg:h-3/4 border-orange-500 border-2">
          ...
          <div style={{width:"100%",height:"auto",paddingTop:"3rem",border:"2px solid blue",display:"flex",justifyContent:"center",alignItems:"center"}}>
            <span style={{fontSize:"8rem",fontWeight:"bold"}}>SmarterScope.AI</span>
          </div>
          ...
          <form onSubmit={handleSubmit} >    
            <div style={{height:"auto",border:"2px solid red",paddingLeft:"8rem",paddingRight:"1rem"}}>
              <input type="text" value={address} onChange={(e) => setaddress(e.target.value)} placeholder="Insert Address Here" style={{border:"2px solid white",padding:"0.5rem",width:"70%",height:"4rem",fontSize:"1rem",borderRadius:"0.5rem",display:"block",marginLeft:"auto",marginRight:"auto",marginBottom:"1rem"}}/>
              <button style={{backgroundColor:"white",color:"black",border:"none",padding:"0.5rem",width:"25%",height:"3rem",fontSize:"1rem",cursor:"pointer",borderRadius:"0.5rem",display:"block",marginLeft:"auto",marginRight:"auto",fontWeight:"bold"}}>Submit</button>
            </div>
          </form>            
        </div>
      </div>
