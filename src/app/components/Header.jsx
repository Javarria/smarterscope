...
const Header = () => {
  return (
    ...
    <div className="h-auto w-full lg:w-[60vw] mx-auto rounded-full shadow-2xl p-4 m-4 mt-8 border-2 border-[rgba(255,255,255,0.2)] flex" style={{ backdropFilter: "blur(40px)", backgroundColor: "rgba(255, 255, 255, 0.2)", borderRadius: "5rem", padding: "1rem",
        ...
        <h1 className="font-bold text-2xl tracking-wide leading-snug md:text-3xl lg:text-3xl xl:text-3xl border-red-500 border-2 ml-3 md:ml-0 md:border-none" style={{marginLeft: "1rem"}} >SMARTERSCOPE.AI</h1>

          <Link href="/instructions" style={{zIndex: 2}}>
            <button className="hidden md:flex md:flex-shrink-0 size-7 absolute right-4 top-1/2 -translate-y-1/2 border-green-600 border-2">
